...
//     c2=event.target.closest("#color2");
//     c1=event.target.closest("#color1");
//     console.log(c1,c2)
...
//         event.target.closest("#color1").textContent=`${colors[colorIndx-1].color1}`;
...
//         event.target.closest("#color2").textContent=`${colors[colorIndx-1].color2}`;
